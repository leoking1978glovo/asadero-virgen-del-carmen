...
export function Dishes() {
  ...
  return (
    <section
      className="bg-cream py-16 md:py-16"
      ...
      <div className="mx-auto max-w-[1600px] px-4 md:px-12">
        <div className="flex items-center justify-between gap-4">
          <motion.h2
            ...
            className="text-3xl text-ink md:text-5xl"
          >
            Nuestros <span className="text-fire">asados</span>
          </motion.h2>
          <div className="flex items-center gap-3">
            ...
            <div className="flex gap-2">
              <button
                onClick={prev}
                aria-label="Anterior"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-ink/20 text-ink transition-colors hover:border-primary hover:bg-primary hover:text-cream"
              >
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-4 md:p-6">
                {current.tag && (
                  <p className="mb-1 text-center text-xs font-semibold tracking-[0.3em] text-secondary uppercase">
                    {current.tag}
                  </p>
                )}
