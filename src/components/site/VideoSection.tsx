...
import asadorVideo from "@/assets/asador.mp4";
      ...
      <div className="relative flex h-full items-center justify-center px-6 text-center">
        ...
        >
          <p className="mb-6 text-xs font-semibold tracking-[0.4em] text-secondary uppercase">
            Fuego lento, sabor grande
          </p>
          <h2 className="mx-auto max-w-[14ch] text-[clamp(2.75rem,10vw,7rem)] text-cream">
            El fuego del <span className="text-fire">asador</span>
          </h2>
          <p className="mx-auto mt-6 max-w-lg text-cream/70">
            Carbón encendido cada mañana y el asador girando sin parar. Así
            suena y huele cada día en el Virgen del Carmen.
          </p>
        </motion.div>
      </div>
    </section>
